...
const buildProducts = () => {
  ...
  if (param != undefined) {
    fetch(`https://localhost:7283/Produse/${param}`)
      .then((response) => response.json())
      .then((products) => {
        // Select the element where the products will be inserted
        ...
        for (const pr of products) {
          ...
          article.setAttribute("id", pr.id);
          article.setAttribute("class", "produs");

          // Create the link element
          let link = document.createElement("a");
          link.setAttribute("href", "/produs/" + pr.id);
          ...
          img.setAttribute("src", "/resurse/pictures/produse/" + pr.imagine);
          ...
          // Create the paragraph element for the product name
          let pName = document.createElement("p");
          pName.setAttribute("class", "nume");

          // Create the span element for the product name value
          let spanName = document.createElement("span");
          spanName.setAttribute("class", "val-nume");
          spanName.textContent = pr.nume;
          ...
          // Create the div element for the product info
          let divInfo = document.createElement("div");
          divInfo.setAttribute("class", "info-prod");

          // Create the paragraph element for the product price
          let pPrice = document.createElement("p");
          pPrice.setAttribute("class", "pret");

          // Create the h3 element for the product price value
          let h3Price = document.createElement("h3");

          // Create the span element for the product price value
          let spanPrice = document.createElement("span");
          spanPrice.setAttribute("class", "val-pret");
          spanPrice.textContent = pr.pret + " lei";

          // Append the span to the h3
          h3Price.appendChild(spanPrice);

          // Append the h3 to the paragraph
          pPrice.appendChild(h3Price);
          ...
          button.setAttribute("class", "buton_cumpara");
          button.textContent = "Adaugă in coș";
    ...
    fetch(`https://localhost:7283/Produse`)
      .then((response) => response.json())
      .then((products) => {
        // Select the element where the products will be inserted
        const container = document.querySelector(".grid-produse");
